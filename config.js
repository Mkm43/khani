...
global.sudo = process.env.SUDO || '923073549844'
global.devs = '923073549844';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'ASSASSIN 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME ===  undefined? 'ASSASSIN' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,VAJIRA;;;HookedSimple
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'assassin' : process.env.PACK_INFO.split(";")[0],
  ...
  LANG: process.env.THEME|| 'ASSASSIN',
